...
// ConfigurationSet provides a mock function with given fields: ctx, devID, configuration
func (_m *App) ConfigurationSet(ctx context.Context, devID uuid.UUID, configuration model.Configuration) error {
